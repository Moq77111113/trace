...
export const load = async ({
    ...
    if (!parsed || parsed.prefix !== project.codePrefix)
...
export async function addManualScenarioAction(input: {
    featureId: string;
    name: string;
}) {
...
export async function renameManualScenarioAction(input: {
    scenarioId: string;
    name: string;
}) {
...
export async function archiveManualScenarioAction(input: {
    scenarioId: string;
}) {
...
export async function reorderManualScenariosAction(input: {
    featureId: string;
    order: string[];
}) {
