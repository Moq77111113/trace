...
CREATE INDEX "runs_feature_started_idx" ON "runs" USING btree ("feature_id","started_at" DESC);--> statement-breakpoint
CREATE UNIQUE INDEX "scenario_results_run_name_unique" ON "scenario_results" USING btree ("run_id","scenario_name");--> statement-breakpoint
